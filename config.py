...
# # 预测/可视化配置
# PREDICT_CONFIG = {
#     "visualize": True,        # 是否保存预测可视化图像（用于离线预测/批量）
#     "save_results": True,     # 是否保存 .npy 等结果文件
#
#     # === 实时预测相关配置 ===
#     "realtime": {
#         "camera_index": 0,            # Windows 下 USB 摄像头索引（端口 x）
#         "save_interval_seconds": 5,   # 每 N 秒保存一次预测结果（.npy/.png）
#         "window_name": "PINN RealTime",   # 实时显示窗口名
#         "show_window": True,          # 是否显示实时窗口（服务器可关闭）
#         # 期望分辨率/帧率等
#         # "capture_width": 1280,
#         # "capture_height": 720,
#     },
...
#     # === 批量文件预测相关配置 ===
#     "file_batch": {
#         "image_extensions": [".png", ".jpg", ".jpeg", ".bmp"],  # 批量扫描的图片后缀
#         # 是否递归子目录、是否保留目录结构等
#         # "recursive": False,
#         # "preserve_tree": False,
#     },
